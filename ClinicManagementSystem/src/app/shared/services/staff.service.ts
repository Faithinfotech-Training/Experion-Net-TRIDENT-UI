...
export class StaffService {
  ...
  constructor(private httpClient: HttpClient) { }
    ...
    //get all staffs
    bindListStaffs(){
      this.httpClient.get(environment.apiUrl + '/api/Staff').toPromise().then(
        response => {
    ...
    bindListQualifications(){
      this.httpClient.get(environment.apiUrl + '/api/Qualifications').toPromise().then(
        response => {
          console.log("from qualification  service");
          
          this.qualify = response as Qualification[];
    ...
    //get  roles
    bindListRoles(){
      this.httpClient.get(environment.apiUrl + '/api/Role').toPromise().then(
        response => {
    ...
    insertQualification(qualify: Qualification): Observable<any>{
      ...
      return this.httpClient.post(environment.apiUrl+"/api/Qualifications" ,qualify);
    }
